...
# history.py generated at 2025/09/02 15:24:32
# host: orionvtech
# port: 37975
# launch command: indago -connect dc:orionvtech.orionvtech.com:57479 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=37975,
        extra_args='-connect dc:orionvtech.orionvtech.com:57479 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 37975
# Verisium: **************************************************************************************
