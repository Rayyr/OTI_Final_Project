...
conflict_xor_data_path_seq seq1; //faild
conflict_reading_with_xor_seq seq2;//passed
reset_seq seq3;//passed
usual_xor_seq seq4;//passed
random_xor_seq seq5;
 

  //overridden new()
  function new(string name="bmu_xor_test",uvm_component parent);
  ...
  task run_phase(uvm_phase phase);
    ...
    seq1= conflict_xor_data_path_seq::type_id::create("seq1");
    seq2= conflict_reading_with_xor_seq::type_id::create("seq2");
    seq3= reset_seq::type_id::create("seq4");
    seq4= usual_xor_seq::type_id::create("seq5");
    seq5=random_xor_seq::type_id::create("seq6");
