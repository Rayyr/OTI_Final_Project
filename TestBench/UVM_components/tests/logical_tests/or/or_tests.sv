...
conflict_or_data_path_seq seq1;
 conflict_reading_with_or_seq seq2;
 random_or_seq seq3;
 reset_seq seq4;
 usual_or_seq seq5;
  ...
  task run_phase(uvm_phase phase);
    ...
    seq1= conflict_or_data_path_seq::type_id::create("seq1");
 seq2=conflict_reading_with_or_seq::type_id::create("seq2");
 seq3=random_or_seq::type_id::create("seq3");  
  seq4=reset_seq::type_id::create("seq4");  
 seq5=usual_or_seq::type_id::create("seq5");  
