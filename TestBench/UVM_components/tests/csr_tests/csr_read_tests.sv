...
conflict_csr_read_data_path_seq seq1;
 conflict_srl_data_path_seq seq2;
full_manual_srl_seq seq3;
...
min_shift_amount_srl_seq seq5;
 ...
 usual_srl_seq seq7;
  ...
  task run_phase(uvm_phase phase);
    ...
    seq1= conflict_csr_read_data_path_seq::type_id::create("seq1");
    seq2= usual_csr_read_data_path_seq::type_id::create("seq2");
