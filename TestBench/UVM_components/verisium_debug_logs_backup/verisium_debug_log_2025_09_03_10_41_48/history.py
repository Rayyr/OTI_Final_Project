...
# history.py generated at 2025/09/03 13:41:48
# host: orionvtech
# port: 42855
# launch command: indago -connect dc:orionvtech.orionvtech.com:38263 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=42855,
        extra_args='-connect dc:orionvtech.orionvtech.com:38263 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 42855
# Verisium: **************************************************************************************
