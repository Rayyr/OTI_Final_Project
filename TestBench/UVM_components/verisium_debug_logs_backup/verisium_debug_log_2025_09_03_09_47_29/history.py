...
# history.py generated at 2025/09/03 12:47:29
# host: orionvtech
# port: 42771
# launch command: indago -connect dc:orionvtech.orionvtech.com:46287 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=42771,
        extra_args='-connect dc:orionvtech.orionvtech.com:46287 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 42771
# Verisium: **************************************************************************************
