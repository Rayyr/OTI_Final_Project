...
# history.py generated at 2025/09/04 17:39:09
# host: orionvtech
# port: 41097
# launch command: indago -connect dc:orionvtech.orionvtech.com:42343 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=41097,
        extra_args='-connect dc:orionvtech.orionvtech.com:42343 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 41097
# Verisium: **************************************************************************************
