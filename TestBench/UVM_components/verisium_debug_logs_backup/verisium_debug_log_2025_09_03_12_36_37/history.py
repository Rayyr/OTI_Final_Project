...
# history.py generated at 2025/09/03 15:36:37
# host: orionvtech
# port: 36189
# launch command: indago -connect dc:orionvtech.orionvtech.com:37471 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=36189,
        extra_args='-connect dc:orionvtech.orionvtech.com:37471 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 36189
# Verisium: **************************************************************************************
