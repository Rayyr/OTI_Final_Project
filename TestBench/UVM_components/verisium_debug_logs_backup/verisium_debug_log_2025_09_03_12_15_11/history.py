...
# history.py generated at 2025/09/03 15:15:11
# host: orionvtech
# port: 36271
# launch command: indago -connect dc:orionvtech.orionvtech.com:59409 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=36271,
        extra_args='-connect dc:orionvtech.orionvtech.com:59409 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 36271
# Verisium: **************************************************************************************
