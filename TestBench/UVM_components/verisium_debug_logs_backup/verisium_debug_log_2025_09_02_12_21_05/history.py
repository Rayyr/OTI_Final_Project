...
# history.py generated at 2025/09/02 15:21:05
# host: orionvtech
# port: 37451
# launch command: indago -connect dc:orionvtech.orionvtech.com:36993 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=37451,
        extra_args='-connect dc:orionvtech.orionvtech.com:36993 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 37451
# Verisium: **************************************************************************************
