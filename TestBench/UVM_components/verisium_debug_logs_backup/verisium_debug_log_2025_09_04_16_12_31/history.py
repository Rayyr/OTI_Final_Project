...
# history.py generated at 2025/09/04 19:12:31
# host: orionvtech
# port: 38187
# launch command: indago -connect dc:orionvtech.orionvtech.com:50193 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=38187,
        extra_args='-connect dc:orionvtech.orionvtech.com:50193 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 38187
# Verisium: **************************************************************************************
