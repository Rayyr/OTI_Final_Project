...
# history.py generated at 2025/09/03 09:19:20
# host: orionvtech
# port: 42519
# launch command: indago -connect dc:orionvtech.orionvtech.com:57571 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=42519,
        extra_args='-connect dc:orionvtech.orionvtech.com:57571 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 42519
# Verisium: **************************************************************************************
