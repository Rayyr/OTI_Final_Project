...
class dont_care_inputs_seq extends uvm_sequence #(bmu_sequence_item);
  
  //register the class into uvm factory
  `uvm_object_utils(dont_care_inputs_seq)
 


  //overriden new()
  function new(string name ="dont_care_inputs_seq");
    super.new(name);
  endfunction
  ...
  task body(); 
    ...
    `uvm_info(get_type_name(), ("Dont care inputs XOring"), UVM_NONE) 
