...
class random_siext_b_seq extends uvm_sequence #(bmu_sequence_item);
  
  //register the class into uvm factory
  `uvm_object_utils(random_siext_b_seq)
 


  //overriden new()
  function new(string name ="random_siext_b_seq");
    super.new(name);
  endfunction
...
repeat (3) begin
 ...
 //random input
   ...
   start_item(seq); 
   `uvm_info(get_type_name(), ("Standard Siext_b random inputs"), UVM_NONE) 
   finish_item(seq); 
