...
`uvm_info(get_type_name(), ("==============================Signed SLT===========================\n"), UVM_NONE) 
 ...
 //disable the Reset signal for the test of test cases 
   ...
   `uvm_info(get_type_name(), ("Standard Signed SLT both pos inputs\n"), UVM_NONE) //passed
      seq.randomize() with {valid_in==1;csr_ren_in==1'b0;a_in>0;b_in>0;}; 
   repeat(3) begin
   start_item(seq); 
   finish_item(seq); 
   end
 ...
 repeat(3) begin
   ...
   `uvm_info(get_type_name(), ("Standard Signed SLT different signs inputs\n"), UVM_NONE) //passed
            seq.randomize() with {valid_in==1;csr_ren_in==1'b0;(a_in>0 && b_in<0) || (b_in>0 && a_in<0);}; 
repeat(3)begin
   start_item(seq); 
   finish_item(seq);
end
   ...
   `uvm_info(get_type_name(), ("Standard Signed SLT with same inputs\n"), UVM_NONE) //passed
      seq.randomize() with {valid_in==1;csr_ren_in==1'b0;a_in==b_in;}; 
repeat(3)begin
   start_item(seq); 
   finish_item(seq); 
end
...
`uvm_info(get_type_name(), ("==============================Unsigned SLT===========================\n"), UVM_NONE) 
...
repeat(3)begin
   ...
   `uvm_info(get_type_name(), ("Standard Unsigned SLT different signs inputs\n"), UVM_NONE) //passed
            seq.randomize() with {valid_in==1;csr_ren_in==1'b0;(a_in>0 && b_in<0) || (b_in>0 && a_in<0);}; 
repeat(3)begin
   start_item(seq); 
   finish_item(seq); 
...
repeat(3)begin
   ...
   `uvm_info(get_type_name(), ("Standard Unsigned SLT with both pos inputs\n"), UVM_NONE) //passed
      seq.randomize() with {valid_in==1;csr_ren_in==1'b0;a_in>0;b_in>0;}; 
repeat(3)begin
   start_item(seq); 
   finish_item(seq); 
