...
class conflict_reading_with_slt_seq extends uvm_sequence #(bmu_sequence_item);
  
  //register the class into uvm factory
  `uvm_object_utils(conflict_reading_with_slt_seq)
 


  //overriden new()
  function new(string name ="conflict_reading_with_slt_seq");
    super.new(name);
  endfunction
