...
class conflict_slt_data_path_seq extends uvm_sequence #(bmu_sequence_item);
  
  //register the class into uvm factory
  `uvm_object_utils(conflict_slt_data_path_seq)
 


  //overriden new()
  function new(string name ="conflict_slt_data_path_seq");
    super.new(name);
  endfunction
