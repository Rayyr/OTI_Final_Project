...
class random_pack_seq extends uvm_sequence #(bmu_sequence_item);
  
  //register the class into uvm factory
  `uvm_object_utils(random_pack_seq)
 


  //overriden new()
  function new(string name ="random_pack_seq");
    super.new(name);
  endfunction
  ...
  task body(); 
   ...
   seq.ap.pack=1'b1;
    ...
    `uvm_info(get_type_name(), ("Standard PACK random inputs"), UVM_NONE) //faild
repeat(20) begin
