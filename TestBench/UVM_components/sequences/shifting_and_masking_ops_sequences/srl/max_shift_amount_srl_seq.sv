...
class max_shift_amount_srl_seq extends uvm_sequence #(bmu_sequence_item);
  
  //register the class into uvm factory
  `uvm_object_utils(max_shift_amount_srl_seq)
 


  //overriden new()
  function new(string name ="max_shift_amount_srl_seq");
    super.new(name);
  endfunction
