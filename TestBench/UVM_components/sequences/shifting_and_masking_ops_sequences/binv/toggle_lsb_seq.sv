...
class toggle_lsb_seq extends uvm_sequence #(bmu_sequence_item);
  
  //register the class into uvm factory
  `uvm_object_utils(toggle_lsb_seq)
 


  //overriden new()
  function new(string name ="toggle_lsb_seq");
    super.new(name);
  endfunction
  ...
  task body(); 
    ...
    `uvm_info(get_type_name(), ("Toggle LSB case with LSB=1"), UVM_NONE) //passed
        seq.randomize() with {csr_ren_in==1'b0;a_in[0]==1'b1; b_in[4:0]==5'b00000;valid_in==1;};
repeat(3) begin
//a_in[lsb]=1 , result=32'b......0  
...
`uvm_info(get_type_name(),("Toggle LSB case with LSB=0"),UVM_NONE)//passed
seq.randomize() with {csr_ren_in==1'b0; a_in[0]==1'b0; b_in[4:0]==5'b00000;valid_in==1;};
repeat(3) begin
