...
class conflict_binv_data_path_seq extends uvm_sequence #(bmu_sequence_item);
  
  //register the class into uvm factory
  `uvm_object_utils(conflict_binv_data_path_seq)
 


  //overriden new()
  function new(string name ="conflict_binv_data_path_seq");
    super.new(name);
  endfunction
 ...
 //disable the Reset signal for the test of test cases 
   ...
   `uvm_info(get_type_name(), ("Conflict BINV data path case"), UVM_NONE) //faild
repeat(3) begin
