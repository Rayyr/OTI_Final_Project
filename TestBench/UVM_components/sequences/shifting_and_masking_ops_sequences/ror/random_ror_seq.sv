...
class random_ror_seq extends uvm_sequence #(bmu_sequence_item);
  
  //register the class into uvm factory
  `uvm_object_utils(random_ror_seq)
 


  //overriden new()
  function new(string name ="random_ror_seq");
    super.new(name);
  endfunction
...
//this will cover all possibilities of rotation amount cases !
